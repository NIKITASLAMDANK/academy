...
import by.academy.homework3.general.Person;
import by.academy.homework3.general.products.Cheese;
import by.academy.homework3.general.products.Meat;
import by.academy.homework3.general.products.Product;
import by.academy.homework3.general.products.Wine;
...
public class Deal {
    ...
    private void readProduct(Product product) {
        ...
        System.out.println("Введите цену продукта в y.e.($)");
    ...
    public String toString() {
        ...
        sb.append(", сумма сделки - ").append(priceBill).append("$");
