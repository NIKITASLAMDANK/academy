...
public class Task2 {
    ...
    public static void main(String[] args) {
        User user = new User("Олег", "Печкин", 18, LocalDate.of(2002, 10, 10),
